...
(() => {
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            html[data-panel-theme="light"] { color-scheme:light; --bg-main:#6f8196; --bg-panel:#8799ad; --bg-panel-hover:#7a8da2; --card:#91a2b5; --border:#455a72; --text-main:#0f172a; --text-muted:#35475d; }
            html[data-panel-theme="light"] body, html[data-panel-theme="light"] main, html[data-panel-theme="light"] #app { background:#6f8196 !important; color:#0f172a !important; }
            html[data-panel-theme="light"] aside { background:#52667d !important; color:#f1f5f9 !important; border-color:#3d5067 !important; }
            html[data-panel-theme="light"] header { background:#71849a !important; color:#0f172a !important; border-color:#52667d !important; }
            html[data-panel-theme="light"] footer { background:#60748a !important; color:#0f172a !important; border-color:#455a72 !important; }
            html[data-panel-theme="light"] :is(.bg-slate-900, [class^="bg-slate-900/"], [class*=" bg-slate-900/"]), html[data-panel-theme="light"] .post, html[data-panel-theme="light"] .dialog, html[data-panel-theme="light"] .panel, html[data-panel-theme="light"] .card { background:#91a2b5 !important; color:#0f172a !important; border-color:#455a72 !important; box-shadow:0 8px 22px rgba(15,23,42,.28); }
            html[data-panel-theme="light"] :is(.bg-slate-950, [class^="bg-slate-950/"], [class*=" bg-slate-950/"]), html[data-panel-theme="light"] input, html[data-panel-theme="light"] textarea, html[data-panel-theme="light"] select, html[data-panel-theme="light"] .poll-option, html[data-panel-theme="light"] .tab, html[data-panel-theme="light"] .reaction, html[data-panel-theme="light"] .audience { background:#7d90a6 !important; color:#0f172a !important; }
            html[data-panel-theme="light"] :is(.bg-slate-800, [class^="bg-slate-800/"], [class*=" bg-slate-800/"]), html[data-panel-theme="light"] .badge { background:#6b7f96 !important; color:#0f172a !important; }
            ...
            html[data-panel-theme="light"] .nav-link { margin-bottom:5px; border:1px solid #71859b; background:#60758a !important; color:#eef4fa !important; box-shadow:0 3px 9px rgba(15,23,42,.22); }
            html[data-panel-theme="light"] .nav-link:hover { background:#71869d !important; border-color:#91a4b7; }
