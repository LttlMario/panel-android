...
(() => {
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            html[data-panel-theme="light"] :is(.bg-slate-900, [class^="bg-slate-900/"], [class*=" bg-slate-900/"]), html[data-panel-theme="light"] .post, html[data-panel-theme="light"] .dialog, html[data-panel-theme="light"] .panel, html[data-panel-theme="light"] .card { background-color:#b7c3cf !important; background-image:linear-gradient(145deg,#c2ccd6 0%,#aab8c6 100%) !important; color:#0f172a !important; border-color:#60758b !important; box-shadow:inset 0 1px 0 rgba(255,255,255,.38),0 10px 25px rgba(15,23,42,.24); }
            html[data-panel-theme="light"] :is(.bg-slate-950, [class^="bg-slate-950/"], [class*=" bg-slate-950/"]), html[data-panel-theme="light"] input, html[data-panel-theme="light"] textarea, html[data-panel-theme="light"] select, html[data-panel-theme="light"] .poll-option, html[data-panel-theme="light"] .tab, html[data-panel-theme="light"] .reaction, html[data-panel-theme="light"] .audience { background-color:#9cabb9 !important; background-image:linear-gradient(145deg,#aab8c6,#91a2b3) !important; color:#0f172a !important; box-shadow:inset 0 1px 0 rgba(255,255,255,.24); }
            html[data-panel-theme="light"] :is(.bg-slate-800, [class^="bg-slate-800/"], [class*=" bg-slate-800/"]), html[data-panel-theme="light"] .badge { background:#8799ac !important; color:#0f172a !important; }
            ...
            html[data-panel-theme="light"] .text-slate-400, html[data-panel-theme="light"] .text-slate-500, html[data-panel-theme="light"] .muted, html[data-panel-theme="light"] .meta { color:#3c4e63 !important; }
