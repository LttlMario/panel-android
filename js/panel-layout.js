...
(() => {
    ...
    function addStyles() {
        ...
        style.textContent = `
            ...
            html[data-panel-theme="light"] body, html[data-panel-theme="light"] main, html[data-panel-theme="light"] #app { background:#8293a6 !important; color:#0f172a !important; }
            html[data-panel-theme="light"] :is(.bg-slate-900, [class^="bg-slate-900/"], [class*=" bg-slate-900/"]), html[data-panel-theme="light"] .post, html[data-panel-theme="light"] .dialog, html[data-panel-theme="light"] .panel, html[data-panel-theme="light"] .card { background:#b7c3cf !important; color:#0f172a !important; border-color:#61758b !important; box-shadow:0 9px 24px rgba(15,23,42,.25); }
